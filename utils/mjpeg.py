...
# class sentojson(object):
#     def __init__(self, init_json=None, ip='', port=8070):
#         global _jsion
#         init_json = init_json if init_json else None
#         _jsion.put(init_json)
#         self.server  =

class MjpegServer(object):
    def __init__(self, init_img=None, ip='', port=8000):
